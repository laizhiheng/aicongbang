    ...
    <el-table :data="rows" border style="width: 100%">
      ...
      <el-table-column fixed="right" label="操作" width="210">
        <template slot-scope="scope">
          <el-button type="primary"  @click="modify(scope.$index,scope.row),dialogFormVisible=true" icon="el-icon-edit">修改</el-button>
        ...
        this.setCurPage(this.maxPage);
                ...
                ok(){
                  ...
                  console.log(this._id)
                    let obj={_id:this._id,petsName:this.petsName,petsClass:this.radio4,petsType:this.petsType,petsColor:this.petsColor,
